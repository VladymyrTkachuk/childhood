            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <img class="specialists__img" src="<?php the_field('your_img'); ?>" alt="наша команда">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        ...
                        <span><?php the_field('title_toys'); ?></span>
                        <?php the_field('сontact_us'); ?>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="aboutus" id="aboutus">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="subtitle">
                            <?php the_field('header_history'); ?>
                        </div>
                        <div class="aboutus__text">
                            <?php the_field('descr_history'); ?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <!-- <img class="aboutus__img" src="<?php echo bloginfo('template_url'); ?>/assets/img/about_1.jpg" alt="мир детства"> -->
                         <img class="aboutus__img" src="<?php the_field('photo_history'); ?>" alt="мир детства">
                    </div>
                </div>

                <div class="row">
                    <div class="col-lg-6">
                         <img class="aboutus__img" src="<?php the_field('photo_history_1'); ?>" alt="мир детства">
                    </div>
                    <div class="col-lg-6">
                        <div class="subtitle">
                            <?php the_field('header_history_1'); ?>
                        </div>
                        <div class="aboutus__text">
                            <?php the_field('descr_history_1'); ?>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="subtitle">
                            <?php the_field('header_history_2'); ?>
                        </div>
                        <div class="aboutus__text">
                            <?php the_field('descr_history_2'); ?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                         <img class="aboutus__img" src="<?php the_field('photo_history_2'); ?>" alt="мир детства">
                    </div>
                </div>
                            ...
                            <div class="contacts__phones">
                                <div class="contacts__phoneblock">
                                    ...
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="tel:<?php  the_field('telephone', 2) ?>"><?php  the_field('telephone', 2) ?></a>
                                    </div>
                                </div>
                                <div class="contacts__phoneblock">
                                    Телефон №2
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="tel:<?php  the_field('telephone_plus', 2) ?>"><?php  the_field('telephone_plus', 2) ?></a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="title contacts__minititle">Оставьте ваш отзыв</div>
                            <div class="contacts__feed">
                               <?php echo do_shortcode('[contact-form-7 id="5884ccd" title="Форма отзывов"]'); ?>
                            </div>
...
<?php 
    ...
    add_filter( 'filter',  'my_filter');

    echo apply_filters( 'filter', 'World' );

    remove_filter( 'filter', 'my_filter');
    echo apply_filters( 'filter', 'World' );
?>
